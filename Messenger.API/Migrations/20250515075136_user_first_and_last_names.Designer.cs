...
namespace Messenger.API.Migrations
{
    ...
    [Migration("20250515075136_user_first_and_last_names")]
    partial class user_first_and_last_names
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Messenger.API.Models.Message", b =>
                {
                    b.HasOne("Messenger.API.Models.User", "Receiver")
                        .WithMany()
                    ...
                    b.HasOne("Messenger.API.Models.User", null)
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_messages_asp_net_users_user_id");

                    b.HasOne("Messenger.API.Models.User", null)
                        .WithMany("SentMessages")
                        .HasForeignKey("UserId1")
                        .HasConstraintName("fk_messages_asp_net_users_user_id1");
